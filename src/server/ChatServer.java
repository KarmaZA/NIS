public static void main(string[] args){
	int portNumber = 4444; //If this doesn't work set up a different port (don't go lower than 1000 most likely in use already)
	serverSocket = null;
	/*
...
public static void acceptClients(){
	clients = new ArrayList<ClientThread>(); //ArrayList for storing clients
